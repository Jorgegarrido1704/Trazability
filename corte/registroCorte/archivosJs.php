<?php 
    ...
    $datos=mysqli_query($con,"INSERT INTO `registroscorte`(`date`,`timeExe`, `wo`, `cons`, `registradoBy`, `udm`, `largoOperador`, `largolista`, `diferencia`) 
    VALUES ('$date','$time','$work','$cons','$control','$udm','$largo','$origlargo','$diff')");
