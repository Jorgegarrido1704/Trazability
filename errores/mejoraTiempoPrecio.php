...
if(date("N") != 7){
    if((strtotime($dateIni) > strtotime(date("d-m-Y 07:00")) and strtotime($dateIni) < strtotime(date("d-m-Y 07:05"))) || (strtotime($dateIni) > strtotime(date("d-m-Y 13:30")) and strtotime($dateIni) < strtotime(date("d-m-Y 13:05"))) ||  (strtotime($dateIni) > strtotime(date("d-m-Y 19:00")) and strtotime($dateIni) < strtotime(date("d-m-Y 19:05")))){
