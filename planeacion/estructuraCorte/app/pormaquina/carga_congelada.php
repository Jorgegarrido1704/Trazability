...
try {
    ...
    $tiempo = '';
    $maxtime = 135000*3;
    $orden_especial=['021158','021122','021138'];
    $tiempoTotal = 0; 
    $i = 0;
...
try {
    ...
    $tiempo = '';
    $maxtime = 135000*3;
    $orden_especial=['021158','021122','021138',' 019104',' 019105','020778'];
    $tiempoTotal = 0; 
    $i = 0;
    ...
    // Construir lista segura para SQL a partir del array de WO especiales
    $orden_especial_sql = implode(',', array_map(function($wo) use ($con) {
        return "'" . mysqli_real_escape_string($con, $wo) . "'";
    }, $orden_especial));
