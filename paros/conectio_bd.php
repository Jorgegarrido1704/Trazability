...
require "conection.php";
	...
	$insertar= "INSERT INTO `registro_paro_corte`(`id`, `fecha`, `equipo`, `nombreEquipo`, `dano`, `quien`, `area`,`atiende`, `trabajo`, `Tiempo`,  `finhora`) VALUES ('','$fecha','$equipo','$nom_eq','$dano','$quien','$area','Nadie aun','','','')";
