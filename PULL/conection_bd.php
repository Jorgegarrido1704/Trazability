...
if($cont=='MT1-4' || $cont=='MT1-54'){
    ...
    if ($calibre == 14 && ($presion <=21)) {
        $insertar = "INSERT INTO `registro`(`id`,`fecha`, `calibre`, `Cliente`, `Num_part`, `wo`, `presion`, `forma`, `cont`, `quien`,`val`,`tipo`) VALUES ('','$fecha', '$calibre', '$cliente', '$num', '$wo', '$presion', '$apply', '$cont', '$personal','$val','malas')";
        $qry = mysqli_query($con, $insertar);
        header('Location: ../pull/error.php');
    } elseif ($calibre == 16 && ($presion <= 19.8)) {
        $insertar = "INSERT INTO `registro_pull`(`id`,`fecha`, `calibre`, `Cliente`, `Num_part`, `wo`, `presion`, `forma`, `cont`, `quien`,`val`,`tipo`) VALUES ('','$fecha', '$calibre', '$cliente', '$num', '$wo', '$presion', '$apply', '$cont', '$personal','$val','malas')";
        $qry = mysqli_query($con, $insertar);
        header('Location: ../pull/error.php');
    ...
    $insertar = "INSERT INTO `registro_pull`(`id`,`fecha`, `calibre`, `Cliente`, `Num_part`, `wo`, `presion`, `forma`, `cont`, `quien`,`val`,`tipo`) VALUES ('','$fecha', '$calibre', '$cliente', '$num', '$wo', '$presion', '$apply', '$cont', '$personal','$val','minfir')";
    $qry = mysqli_query($con, $insertar);  
...
// Check the calibre value and corresponding pressure range
    ...
    $insertar = "INSERT INTO `registro_pull`(`id`,`fecha`, `calibre`, `Cliente`, `Num_part`, `wo`, `presion`, `forma`, `cont`, `quien`,`val`,`tipo`) VALUES ('','$fecha', '$calibre', '$cliente', '$num', '$wo', '$presion', '$apply', '$cont', '$personal','$val','OK')";
    $qry = mysqli_query($con, $insertar);
