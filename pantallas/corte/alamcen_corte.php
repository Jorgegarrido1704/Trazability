...
<div id="app">
 ...
 <div class="container-fluid px-4 tab-content-all" id="materialistas">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            seleccionar maquina: 
            <select name="maquina_material" id="maquina_material" class="form-select" onchange="actualizarMaterialista(this.value)">
                <option value="" disabled selected>Seleccione Maquina</option>
        ...
        .then(data => {
            ...
            Object.keys(terminals).forEach(key => {
                ...
                if(posiblesTerminales[material].includes(key)){
                    tbodyTerminals.innerHTML += `<tr><td class="bg-success"><strong>${key}</strong></td></tr>`;
                }else{
...
function actualizarMaterialista(maquina) {
