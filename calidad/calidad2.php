...
if ($usuario === "cali" || $admin === "Admin") {
    ...
    <form action="guardar.php" method="POST" id="guardar" name="guardar">
                ...
                <h2><label for="1">Codigo #1</label><input type="text" width="10px" name="1" id="1" value='0' required onchange="return datacheck()"><label for="c1">Cantidad</label><input type="number" name="c1" id="c1" value='0' min='0'></h2>  
                <h2><label for="2">Codigo #2</label><input type="text" width="10px" name="2" id="2" value='0'  required onchange="return datacheck()"><label for="c2">Cantidad</label><input type="number" name="c2" id="c2" value='0' min='0'></h2>  
                <h2><label for="3">Codigo #3</label><input type="text" width="10px" name="3" id="3" value='0'  required onchange="return datacheck()"><label for="c3">Cantidad</label><input type="number" name="c3" id="c3" value='0' min='0'></h2>  
                <h2><label for="4">Codigo #4</label><input type="text" width="10px" name="4" id="4" value='0'  required onchange="return datacheck()"><label for="c4">Cantidad</label><input type="number" name="c4" id="c4" value='0' min='0'></h2>  
               
                <h2><label for="5">Codigo #5</label><input type="text" width="10px" name="5" id="5" value='0'  required onchange="return datacheck()"><label for="c5">Cantidad</label><input type="number" name="c5" id="c5" value='0' min='0'></h2>  
...
<script>
 ...
 function alert(){
    ...
    function Validar() {
        ...
        if (vali===BarCode[x] & numnok>=0 & rest>=0){             
            return true;   }} 
            return false;
